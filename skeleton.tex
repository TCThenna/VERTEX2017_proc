...
\begin{figure}[t!]
  ...
  \includegraphics[width=0.45\textwidth]{figures/oneDistLogy.eps} \put(-165, 170){(A)}\hspace{0.02\textwidth}
...
\begin{figure}[t!]
  ...
  \includegraphics[width=0.45\textwidth]{figures/estimators3.eps} \put(-165, 170){(B)}\\%
