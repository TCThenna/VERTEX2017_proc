...
\begin{figure}[t!]
  \centering
  %\includegraphics[width=0.49\textwidth]{img/run28_1GeV_01mm_gblsumkxandsumky_xyP_mean.eps}  
  \includegraphics[width=0.48\textwidth]{figures/edgesMAD90s120.eps} \put(-115, 115){(A)}\hspace{0.02\textwidth}
  \includegraphics[width=0.48\textwidth]{figures/edgesRMS95s120.eps} \put(-115, 115){(B)}\\%
    \caption[contrast]{%
    (A) Contrast and reso for estimator a+b/2 (rms$_{95}$). %FIXME
    (B) Contrast and reso for estimator h) (AAD$_{90}$).}
  \label{fig:contrast}
\end{figure}
...
\begin{figure}[t!]
  \centering
  %\includegraphics[width=0.49\textwidth]{img/run28_1GeV_01mm_gblsumkxandsumky_xyP_mean.eps}  
  \includegraphics[width=0.70\textwidth]{figures/CvsRes.eps}
    \caption[contrast]{%
